...
适合合同、证明、内部资料等常见场景。可以调整公司名称、印章类型、编码、五角星、内圈和防伪纹路。

![圆形合同章示例](public/stamp_template.png)

### 椭圆财务章

适合财务专用章、发票章、收讫章等横向内容较多的场景。椭圆模板默认保留中间文字、编码和底部编号区域。

![椭圆财务章示例](public/stamp_rectangle.png)

### 透明 PNG 导出

适合插入 Word、PDF、表格或其他文档。PNG 默认支持透明背景，也可以在导出时切换白底。

![透明 PNG 导出示例](public/stamp_export.png)

### 图片提取印章

适合从扫描件或照片中提取红色印章区域。图片在浏览器本地处理，提取后可以直接替换到画布继续调整。

![图片提取印章示例](public/stamp_extract.png)
