  ...
  zh: {
    ...
    stamp: {
      ...
      exportFormat: {
        ...
        ratioTitle: '固定比例',
        ratioHint: '选择图片宽高比；章体保持比例，空余区域留白',
        ratioOriginal: '原始比例',
        ratioSquare: '正方形',
        ratioCustom: '自定义',
        cancel: '取消',
  ...
  en: {
    ...
    stamp: {
      ...
      exportFormat: {
        ...
        svgDesc: 'Embedded PNG bitmap, not lossless vector',
        ...
        ratioHint: 'Choose image proportions; the stamp stays proportional with padding',
